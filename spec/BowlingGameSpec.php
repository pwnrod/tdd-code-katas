...
class BowlingGameSpec extends ObjectBehavior {
    ...
    function it_take_exception_with_invalid_rolls() {
        $this->shouldThrow('InvalidArgumentException')->duringRoll(-10);
    }

//    HELPER METHODS BELOW ____________________________________________
    ...
    private function rollTimes($count, $pins): void
    {
        for ($i = 0; $i < $count; $i++) {
            $this->roll($pins);
        }
